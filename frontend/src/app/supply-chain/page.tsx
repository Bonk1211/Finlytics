    ...
    <div className="flex flex-col h-full w-full p-8 bg-[#F8FAFC]">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
          <Package className="w-8 h-8 text-indigo-600" /> Automated Supply Chain Management
        </h1>
        <p className="text-gray-500 mt-2 text-sm font-medium">Smart inventory tracking and demand forecasting connecting MSMEs to regional suppliers.</p>
      </div>
      ...
      <div className="flex gap-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 flex-[0.8] flex flex-col gap-5">
           <h2 className="text-sm font-bold text-gray-900 uppercase tracking-wider flex justify-between items-center">
             Sourcing Request
             <span className="text-[10px] bg-indigo-100 text-indigo-700 font-bold px-2 py-1 rounded">AI Procurement</span>
           </h2>
           
           <div>
              <label className="text-xs font-bold text-gray-500 uppercase tracking-wide">Product Needed</label>
           ...
           <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-xs font-bold text-gray-500 uppercase tracking-wide flex items-center gap-1"><ShoppingCart className="w-3 h-3"/> Required Qty</label>
              ...
              <div>
                <label className="text-xs font-bold text-gray-500 uppercase tracking-wide flex items-center gap-1"><Clock className="w-3 h-3"/> Max Lead Time (Days)</label>
              ...
              <div className="col-span-2">
                <label className="text-xs font-bold text-gray-500 uppercase tracking-wide flex items-center gap-1"><MapPin className="w-3 h-3"/> Target Sourcing Region</label>
           ...
           >
             ...
             {loading ? "" : "Analyze Routing & Find Suppliers"}
           </button>
        </div>
          ...
          {result ? (
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 flex flex-col h-full overflow-y-auto">
               <h2 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-6 flex items-center gap-2">
                 <ShieldCheck className="w-5 h-5 text-green-500" /> Recommended Suppliers Ranked
               </h2>
               ...
               {result.error ? (
                  <div className="bg-red-50 border border-red-200 p-4 rounded-xl flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-red-800 text-sm">Failed to resolve recommendations</h4>
                 ...
                 <div className="space-y-4">
                      ...
                      <div key={idx} className="border border-gray-100 bg-gray-50 rounded-xl p-4 flex justify-between items-center hover:shadow-md transition">
                        <div>
                          ...
                          <div className="flex gap-4 mt-2 text-xs font-semibold text-gray-500">
                             ...
                             <span className="flex items-center gap-1"><Clock className="w-3 h-3 text-gray-400"/> {rec.lead_time_days || "12"} Days</span>
                    ...
                    {(!result.recommendations || result.recommendations.length === 0) && (
                      <div className="text-center py-10">
                         <span className="text-gray-400 font-bold mb-2 block">Found optimal routing configurations.</span>
            ...
            <div className="bg-gray-50 rounded-2xl border border-gray-200 border-dashed flex-1 flex flex-col items-center justify-center p-8 text-center h-full">
              ...
              <h3 className="text-gray-500 font-bold text-lg">Awaiting Query</h3>
              <p className="text-gray-400 text-sm mt-2 max-w-sm">Use the form to trigger the AI procurement and automated routing logic to map ASEAN regional suppliers.</p>
            </div>
          )}
        </div>
      </div>
