...
export default function DashboardPage() {
  ...
  const TUTORIAL_STEPS = [
    {
      ...
      descKey: "tutorial.navDashboard.desc",
    },
    {
      id: "nav-credit",
      selector: "nav a[href='/credit-scoring']",
      titleKey: "tutorial.navCredit.title",
      descKey: "tutorial.navCredit.desc",
    },
    {
      id: "nav-supply",
      selector: "nav a[href='/supply-chain']",
      titleKey: "tutorial.navSupply.title",
      descKey: "tutorial.navSupply.desc",
    },
    {
      id: "nav-world",
      selector: "nav a[href='/']",
      titleKey: "tutorial.navWorld.title",
      descKey: "tutorial.navWorld.desc",
    },
    {
      id: "nav-trade",
      selector: "nav a[href='/trade-navigator']",
      titleKey: "tutorial.navTrade.title",
      descKey: "tutorial.navTrade.desc",
    },
    {
      id: "nav-visibility",
      selector: "nav a[href='/visibility-engine']",
      titleKey: "tutorial.navVisibility.title",
      descKey: "tutorial.navVisibility.desc",
    },
    {
      id: "header",
      titleKey: "tutorial.header.title",
      descKey: "tutorial.header.desc",
    },
    {
      id: "kpi",
      titleKey: "tutorial.kpi.title",
      descKey: "tutorial.kpi.desc",
    },
    {
      id: "cashflow",
      titleKey: "tutorial.cashflow.title",
      descKey: "tutorial.cashflow.desc",
    },
    {
      id: "pnl",
      titleKey: "tutorial.pnl.title",
      descKey: "tutorial.pnl.desc",
    },
    {
      id: "process",
      titleKey: "tutorial.process.title",
      descKey: "tutorial.process.desc",
    },
  ];
  ...
  return (
    <div className="flex flex-col gap-6 relative px-6 py-6 max-w-screen-2xl mx-auto">
      ...
      <div data-tour="header" className={`flex items-center justify-between pb-2 ${highlightClass("header")}`}>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm font-medium text-gray-500">{t("dashboard.reportCurrency")}</span>
          ...
          <div className="flex items-center gap-2 text-sm font-medium border border-gray-200 rounded-lg px-3 py-1.5 hover:bg-gray-50 cursor-pointer">
            <span className="text-gray-500">{t("dashboard.reportDate")}</span>
      ...
      {/* ── Welcome Title ── */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900">{t("dashboard.greeting")}</h2>
        <p className="text-sm text-gray-500">{t("dashboard.greetingSub")}</p>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div data-tour="kpi" className={`col-span-12 xl:col-span-3 flex flex-col gap-4 ${highlightClass("kpi")}`}>
          ...
          <div className="bg-white rounded-[16px] p-5 border border-gray-100 shadow-sm relative overflow-hidden">
            <div className="flex justify-between items-start mb-2">
              <div className="flex items-center gap-2 text-sm font-medium text-gray-600">
                <DollarSign className="h-4 w-4" /> {t("dashboard.totalRevenue")}
              </div>
              <button className="text-[11px] font-semibold flex items-center gap-1 border border-gray-200 rounded px-2 py-0.5 hover:bg-gray-50">
                {t("dashboard.analytics")} <ExternalLink className="h-3 w-3" />
              </button>
            </div>
          ...
          <div className="bg-white rounded-[16px] p-5 border border-gray-100 shadow-sm relative overflow-hidden">
            <div className="flex justify-between items-start mb-2">
              <div className="flex items-center gap-2 text-sm font-medium text-gray-600">
                <TrendingDown className="h-4 w-4" /> {t("dashboard.expenses")}
              </div>
              <button className="text-[11px] font-semibold flex items-center gap-1 border border-gray-200 rounded px-2 py-0.5 hover:bg-gray-50">
                {t("dashboard.reportManager")} <ExternalLink className="h-3 w-3" />
              </button>
            </div>
            <div className="flex items-baseline gap-3 mt-4">
          ...
          <div className="bg-white rounded-[16px] p-5 border border-gray-100 shadow-sm relative overflow-hidden">
            <div className="flex justify-between items-start mb-2">
              <div className="flex items-center gap-2 text-sm font-medium text-gray-600">
                <TrendingUp className="h-4 w-4" /> {t("dashboard.netProfit")}
              </div>
              <button className="text-[11px] font-semibold flex items-center gap-1 border border-gray-200 rounded px-2 py-0.5 hover:bg-gray-50">
                {t("dashboard.pnl")} <ExternalLink className="h-3 w-3" />
              </button>
            </div>
            <div className="flex items-baseline gap-3 mt-4">
        ...
        <div data-tour="cashflow" className={`col-span-12 xl:col-span-9 bg-white rounded-[16px] border border-gray-100 shadow-sm p-6 ${highlightClass("cashflow")}`}>
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-bold text-gray-900">{t("dashboard.cashFlow")}</h3>
            <div className="flex space-x-2 text-xs font-semibold">
              <button className="px-3 py-1 text-gray-500 hover:text-gray-900">{t("dashboard.monthly")}</button>
              <button className="px-3 py-1 text-gray-500 hover:text-gray-900">{t("dashboard.weekly")}</button>
              <button className="px-3 py-1 text-gray-500 hover:text-gray-900">{t("dashboard.daily")}</button>
              <button className="px-3 py-1 bg-gray-100 text-gray-900 rounded-md">{t("dashboard.dailyColumns")}</button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-6 mt-4 opacity-80">
            <div className="flex items-center gap-2 text-xs font-medium text-gray-600"><div className="w-2 h-2 rounded-full bg-green-500"></div> {t("dashboard.cashIn")}</div>
            <div className="flex items-center gap-2 text-xs font-medium text-gray-600"><div className="w-2 h-2 rounded-full bg-yellow-400"></div> {t("dashboard.cashOut")}</div>
            <div className="flex items-center gap-2 text-xs font-medium text-gray-600"><div className="w-4 h-0.5 bg-gray-400"></div> {t("dashboard.netCash")}</div>
            <div className="flex items-center gap-2 text-xs font-medium text-gray-600"><div className="w-2 h-2 rounded-full border-2 border-gray-400 bg-white"></div> {t("dashboard.runningBalance")}</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div data-tour="pnl" className={`col-span-12 xl:col-span-12 bg-white rounded-[16px] border border-gray-100 shadow-sm p-6 ${highlightClass("pnl")}`}>
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-bold text-gray-900">{t("dashboard.pnlMonitoring")}</h3>
            <div className="flex space-x-2 text-xs font-semibold">
              <button className="px-3 py-1 text-gray-500 hover:text-gray-900">{t("dashboard.monthly")}</button>
              <button className="px-3 py-1 text-gray-500 hover:text-gray-900">{t("dashboard.weekly")}</button>
              <button className="px-3 py-1 text-gray-500 hover:text-gray-900">{t("dashboard.daily")}</button>
              <button className="px-3 py-1 bg-gray-100 text-gray-900 rounded-md">{t("dashboard.hourly")}</button>
            </div>
          </div>
      ...
      <div data-tour="process" className={`bg-white rounded-[16px] border border-gray-100 shadow-sm overflow-hidden flex flex-col md:col-span-12 mt-2 ${highlightClass("process")}`}>
        ...
        <div className="flex justify-between items-center p-5 border-b border-gray-100">
          <h3 className="font-bold text-gray-900 text-sm">{t("dashboard.smartProcess")}</h3>
          <button className="flex items-center gap-2 text-xs font-semibold text-gray-600 border border-gray-200 rounded-md px-3 py-1.5 hover:bg-gray-50 bg-white transition-colors">
            {t("dashboard.print")} <Printer className="w-3.5 h-3.5" />
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 min-h-[400px]">
           ...
           <div className="border-r border-gray-100 p-5 flex flex-col gap-4 bg-white/50">
              <div className="flex justify-between items-center mb-1">
                 <h4 className="font-bold text-gray-800 text-xs">{t("dashboard.insightMetrics")}</h4>
                 <Plus className="w-4 h-4 text-gray-400 cursor-pointer hover:text-gray-900" />
              </div>
              <div className="relative mb-2">
                 <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-gray-400" />
                 <input placeholder={t("dashboard.search")} className="w-full text-xs pl-9 pr-10 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:border-gray-300" />
              ...
              <div className="border border-gray-100 rounded-xl p-4 shadow-sm relative group hover:border-gray-300 cursor-pointer bg-white transition-all">
                 ...
                 <h5 className="text-xs font-bold text-gray-800">{t("dashboard.automationCoverage")}</h5>
                 <p className="text-[10px] text-gray-500 mt-1.5">{t("dashboard.automationDesc")} <span className="font-bold text-gray-700">72%</span></p>
              </div>

              <div className="border border-gray-100 rounded-xl p-4 shadow-sm relative group hover:border-gray-300 cursor-pointer bg-white transition-all">
                 <Plus className="w-3.5 h-3.5 text-gray-300 absolute right-3 top-3 opacity-0 group-hover:opacity-100 hover:text-gray-500" />
                 <h5 className="text-xs font-bold text-gray-800">{t("dashboard.businessFlowA")}</h5>
                 <p className="text-[10px] text-gray-500 mt-1.5 mb-3">{t("dashboard.businessFlowATrigger")}</p>
           ...
           <div className="col-span-2 relative bg-gray-50 p-8 flex items-center justify-center overflow-hidden border-r border-gray-100">
               ...
               <div className="relative z-10 w-full h-full min-h-[300px]">
                  ...
                  <div className="absolute left-[5%] top-1/2 -translate-y-1/2 flex items-center gap-3 bg-white border border-gray-200 rounded-xl p-2.5 shadow-sm whitespace-nowrap z-20">
                     ...
                     <div>
                       <div className="text-[11px] font-bold text-gray-800">{t("dashboard.customerSatisfaction")}</div>
                       <div className="text-[9px] text-gray-400 mt-0.5">{t("dashboard.customerSatisfactionDesc")}</div>
                     </div>
                  </div>
                  ...
                  <div className="absolute left-[40%] top-[15%] flex items-center gap-3 bg-white border border-gray-200 rounded-xl p-2.5 shadow-sm whitespace-nowrap z-20">
                     ...
                     <div>
                       <div className="text-[11px] font-bold text-gray-800">{t("dashboard.automationCoverage")}</div>
                       <div className="text-[9px] text-gray-400 mt-0.5">{t("dashboard.automationDesc")} 72%</div>
                     </div>
                  </div>
                  ...
                  <div className="absolute right-[5%] top-[52%] flex items-center gap-3 bg-white border border-gray-200 rounded-xl p-2.5 shadow-sm whitespace-nowrap z-20">
                     ...
                     <div>
                       <div className="text-[11px] font-bold text-gray-800">{t("dashboard.performanceOpt")}</div>
                       <div className="text-[9px] text-gray-400 mt-0.5">{t("dashboard.performanceOptDesc")}</div>
                     </div>
                  </div>
           ...
           <div className="p-5 flex flex-col gap-4 bg-white/50">
              <div className="flex justify-between items-center mb-1">
                 <h4 className="font-bold text-gray-800 text-xs">{t("dashboard.exceptionManager")}</h4>
                 <Plus className="w-4 h-4 text-gray-400 cursor-pointer hover:text-gray-900" />
              </div>
              <div className="relative mb-2">
                 <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-gray-400" />
              ...
              <div className="border border-gray-100 rounded-xl p-4 shadow-sm relative group hover:border-gray-300 cursor-pointer bg-white transition-all">
                 <Plus className="w-3.5 h-3.5 text-gray-300 absolute right-3 top-3 opacity-0 group-hover:opacity-100 hover:text-gray-500" />
                 <h5 className="text-xs font-bold text-gray-800">{t("dashboard.businessFlowA")}</h5>
                 <p className="text-[10px] text-gray-500 mt-1.5">{t("dashboard.businessFlowATrigger")}</p>
              </div>
               ...
               <div className="border border-gray-100 rounded-xl p-4 shadow-sm relative group hover:border-gray-300 cursor-pointer bg-white transition-all opacity-70">
                 <Plus className="w-3.5 h-3.5 text-gray-300 absolute right-3 top-3 opacity-0 group-hover:opacity-100 hover:text-gray-500" />
                 <h5 className="text-xs font-bold text-gray-800">{t("dashboard.businessFlowB")}</h5>
                 <p className="text-[10px] text-gray-500 mt-1.5">{t("dashboard.businessFlowBTrigger")}</p>
              </div>
           </div>
        </div>
      </div>
        ...
        <>
          ...
          >
            <p className="text-[10px] font-black uppercase tracking-[0.16em] text-green-600 mb-2">
              {t("dashboard.dashboardTutorial")}
            </p>
            <h3 className="text-lg font-black text-gray-900 leading-tight">{t(activeStep.titleKey)}</h3>
            <p className="text-sm text-gray-600 mt-2 leading-relaxed">{t(activeStep.descKey)}</p>

            <div className="mt-4 flex items-center justify-between">
              <span className="text-xs font-semibold text-gray-500">
                {t("dashboard.step")} {tourStepIndex + 1} {t("dashboard.of")} {TUTORIAL_STEPS.length}
              </span>
              <button
                onClick={() => setTourOpen(false)}
            ...
            <div className="mt-4 flex items-center justify-between gap-2">
              ...
              >
                {isLastStep ? t("dashboard.finish") : t("dashboard.next")}
